...
An email thread that started as a quick conversation becomes a real obligation, but you never formally entered it into any system. It lives only in the email chain. Weeks later, the other person follows up, and you think: *oh. That thing. I was supposed to be doing that.* I didn't forget because you're forgetful (well...). I forgot because I never moved it from "interesting correspondence" to "actual project". It strongly goes back to "where the project lives", doesn't it?
