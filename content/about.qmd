...
```
<br>
> Scientific discovery is a social process: it depends as much on biological data as it does on the infrastructure used to share it.
...
Practicing [Open Science](open-science.qmd) is both a technical choice and a cultural one. I am committed to advancing transparency and reproducibility through literal infrastructure—ensuring data is not just "available" but actually usable.
