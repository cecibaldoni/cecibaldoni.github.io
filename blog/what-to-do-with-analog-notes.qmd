...
A meeting where I needed to hold five things in my head at once rely to a note that spend itself soon after the meeting. Eventually, they all fated to the most unnerving and the most reassuring destiny: the notebook fills up, and **it goes on a shelf**.
...
And I know that, because most of the sketches I found in my notebooks look eerily identical to the digitised version, which makes me think that was not really a half baked thought that needed it's own digital space.
...
A sketch is just the thing it is a sketch of, and it keeps for as long as I keep the notebook. When one of them does cross over to digital, the reason is specific and obvious: I am making the actual *final* thing.

Exibit A:

::: {layout-ncol="2"}
![The notebook version](img/sketch-finished-1.png)

![The finished piece](img/sketch-finished-1-final.png)
:::

::: {layout-ncol="2"}
![Years earlier, same habit](img/sketch-finished-2.png)

![Same path, different drawing](img/sketch-finished-2-final.png)
:::
