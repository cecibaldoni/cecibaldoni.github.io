...
Trained as a behavioural biologist, with a PhD and postdoc on how a shrinking, regrowing brain changes what a shrew can do. These days I work in scientific marketing, still working out which half the job titles actually mean.<br><br>

Beyond that, I still teach, mentor, illustrate, and write about how people think and work.
...
<div style="text-align: center; margin: 0 0 24px 0;">
  <div style="display: inline-flex; align-items: center; gap: 10px; padding: 7px 15px; box-shadow: 0 0 0 2px #e8c97e, 0 0 0 5px #0f3318; border-radius: 6px; background: #0f3318; font-family: Roboto Mono", monospace; margin: 6px;">
    ...
    <span style="font-size: 16px; color: #fdf6ee; font-family: Roboto Mono", monospace;">
...
<div class="city-wrapper">
  <div class="city-layer">
    ...
    <div class="icon-illustration-banner">
      <img src="img/icons/banner.svg" alt="Commissions">
    </div>
